...
import { NButton, NCard, NEmpty, NRate, NSpin, NTag, NSpace, NCountdown, NIcon } from 'naive-ui'
  ...
  <div class="mx-4">
    <NSpin :show="loading">
      <NEmpty
        ...
        :description="loading ? '加载中...' : '没有发布任何模拟考试'"
        class="mt-5 p-2"
      >
        <template #extra>
          <NButton ghost size="small">尝试刷新</NButton>
        </template>
      </NEmpty>
